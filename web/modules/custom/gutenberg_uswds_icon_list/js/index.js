...
var iconList = {
  ...
  edit: function edit(_ref) {
    ...
    var ICON_TEMPLATE = [['uswds/icon-list-item', {}]];
    var classList = 'usa-icon-list';
    if (size != 'default') {
      classList += ' usa-icon-list--size-' + size;
    }
    return React.createElement(Fragment, null, React.createElement("ul", {
      className: classList
    }, React.createElement(InnerBlocks, {
      allowedBlocks: ['uswds/icon-list-item'],
...
var iconListItem = {
  ...
  edit: function edit(_ref3) {
    ...
    var mediaEntityId = attributes.mediaEntityId,
    ...
    var descriptionClass = ' usa-icon-list__icon';
    var loading = false;
    ...
    var getIconEntity = function () {
      var _ref4 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(item) {
    ...
    var objectClass = 'usa-icon';
    var uniqueId = 'media-icon_list-' + mediaEntityId;
    return React.createElement(Fragment, null, React.createElement("li", {
      class: "usa-icon-list__item"
    }, mediaEntityId ? React.createElement("div", {
    ...
    })), React.createElement(InspectorControls, null, React.createElement(Fragment, null, React.createElement(PanelColorSettings, {
      ...
      className: "throbber"
    }, "\xA0"))))) : React.createElement(Placeholder, {
...
registerBlockType("".concat(category.slug, "/icon-list-item"), _objectSpread({
  category: category.slug,
  parent: ['uswds/icon-list']
}, iconListItem));
registerBlockType("".concat(category.slug, "/icon-list"), _objectSpread({
  category: category.slug
}, iconList));